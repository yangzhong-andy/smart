...
async function resetAdminPassword() {
  try {
    ...
    if (!email || !newPassword) throw new Error('ADMIN_EMAIL and ADMIN_NEW_PASSWORD must be set');
    if (newPassword.length < 12) throw new Error('ADMIN_NEW_PASSWORD must be at least 12 characters');
