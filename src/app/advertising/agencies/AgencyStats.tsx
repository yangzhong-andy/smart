    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-xs text-slate-400 mb-0.5">总实际消耗</p>
            <p className="text-xl font-bold text-slate-100" style={{ fontFamily: "'JetBrains Mono', monospace" }}>
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-xs text-slate-400 mb-0.5">赠款消耗</p>
            <p className="text-xl font-bold text-purple-300" style={{ fontFamily: "'JetBrains Mono', monospace" }}>
              {formatCurrency(stats.totalGiftConsumption, stats.mainCurrency as "USD" | "CNY" | "HKD", "expense")}
            </p>
          </div>
        </div>
      </div>
