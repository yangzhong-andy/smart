          ...
          <table className="w-full text-sm">
            <thead className="bg-slate-800/60">
              <tr>
                ...
                <th className="px-3 py-3 text-right font-medium text-slate-300">总消耗</th>
                <th className="px-3 py-3 text-right font-medium text-slate-300">可用余额</th>
              ...
              {adAccounts.map((account) => {
                ...
                return (
                  <tr key={account.id} className="hover:bg-slate-800/40">
                    ...
                    <td className="px-3 py-3 text-slate-300">{account.currency}</td>
                    <td className="px-3 py-3 text-right text-rose-300 font-medium">
                      {formatCurrency(totalConsumption, account.currency, "expense")}
                    </td>
