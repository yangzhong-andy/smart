        ...
        <div className="rounded-xl border border-slate-800 bg-slate-900/60 overflow-hidden">
          <table className="w-full">
            ...
            <tbody className="divide-y divide-slate-800">
              {paginate(filteredRecords, pgPage, pgPageSize).map((record) => (
          ...
          <Pagination total={filteredRecords.length} page={pgPage} pageSize={pgPageSize} onPageChange={setPgPage} onPageSizeChange={setPgPageSize} />
        </div>
      )}
    </div>
  );
