              ...
              <div className="bg-slate-800/60 rounded-lg p-4 border border-white/10">
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    >
                      {selectedBill.billCategory === "Receivable" && selectedBill.status === "Paid" ? "已回款" : statusLabels[selectedBill.status] || selectedBill.status}
                    </span>
                  </div>
                </div>
              </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div>
                    <div className="text-xs text-slate-400 mb-1">
                      {selectedBill.billType === "广告返点" ? "返点应收金额" : "应付金额"}
                    </div>
                    <div
                ...
                <div className="bg-slate-800/60 rounded-lg p-4 space-y-3">
                  ...
                  {selectedBill.submittedToFinanceAt && (
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        <div className="text-xs text-slate-400">提交财务审批</div>
                        <div className="text-xs text-slate-500 mt-0.5">
                  ...
                  {selectedBill.financeReviewedBy && (
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        <div className="text-xs text-slate-400">财务审批通过</div>
                        <div className="text-sm text-slate-200">{selectedBill.financeReviewedBy}</div>
              ...
              {selectedExpenseRequest ? (
                <>
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    {(selectedExpenseRequest as any).containerNo && (
                      <div>
                        <div className="text-xs text-slate-400 mb-1">柜号</div>
                        <div className="text-cyan-300 font-medium">{(selectedExpenseRequest as any).containerNo}</div>
                      </div>
                    )}
