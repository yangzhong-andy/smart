    ...
    >
      ...
      <div className="mb-4 flex items-start justify-between gap-3">
        ...
        <div className="flex items-center gap-1 shrink-0">
          ...
          <button
            onClick={onEdit}
            className="rounded-lg p-2 text-slate-400 hover:bg-primary-500/20 hover:text-primary-300 transition-colors"
            title="编辑"
          >
          ...
          <button
            onClick={onDelete}
            className="rounded-lg p-2 text-slate-400 hover:bg-rose-500/20 hover:text-rose-300 transition-colors"
            title="删除"
          >
