...
export const EXPENSE_CATEGORIES: ExpenseCategory[] = [
  ...
  },
  {
    ...
    subCategories: [
      ...
      { label: "卸柜入库", value: "物流/卸柜入库" },
      { label: "海外仓一件代发费", value: "物流/海外仓一件代发费" }
    ]
  },
  {
    label: "广告费",
  ...
  },
  {
    ...
    value: "应收款",
    subCategories: [
      { label: "投资", value: "应收款/投资" },
      { label: "借款", value: "应收款/借款" },
      { label: "个人预支", value: "应收款/个人预支" },
      { label: "其他应收", value: "应收款/其他应收" }
    ]
  },
  {
    label: "运营费用",
